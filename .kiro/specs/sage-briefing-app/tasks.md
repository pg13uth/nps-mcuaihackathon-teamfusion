...
- [ ] 1. Set up project structure, shared types, and testing framework
  - [ ] 1.1 Scaffold the monorepo and shared domain types
  ...
  - [ ] 1.2 Define the 34-SME arsenal data
...
- [ ] 2. Implement intake, constraint resolution, and triage (pure orchestration)
  - [ ] 2.1 Implement ConstraintResolver
...
- [ ] 3. Implement SME selection, sequencing, and routing block (pure orchestration)
  - [ ] 3.1 Implement SmeSelector
  ...
  - [ ] 3.4 Implement RoutingBlockBuilder
...
- [ ] 5. Implement document grounding and citation checking (pure orchestration)
  - [ ] 5.1 Implement GroundingFilter
...
- [ ] 6. Implement staged prompt assembly (pure orchestration)
  - [ ] 6.1 Implement PromptAssembler
...
- [ ] 7. Implement output structure validators (pure orchestration)
  - [ ] 7.1 Implement brief validator
  ...
  - [ ] 7.3 Implement storyboard validator
  ...
  - [ ] 7.5 Implement battle rhythm and orders/curriculum validators
...
- [ ] 9. Implement Synthesis Gate, CCIR engine, and running estimate (pure orchestration)
  - [ ] 9.1 Implement SynthesisGate
  ...
  - [ ] 9.5 Implement RunningEstimateService
...
- [ ] 10. Implement side-effecting adapters
  - [ ] 10.1 Implement AiClient (OpenAI-compatible)
  ...
  - [ ] 10.3 Implement S3DocumentAdapter and TextExtractor
  ...
  - [ ] 10.5 Implement Repository (local file-backed store)
...
- [ ] 12. Implement configuration loading and Express routes (wiring)
  - [ ] 12.1 Implement configuration loader
  ...
  - [ ] 12.2 Implement task and generation routes with staged generation
  ...
  - [ ] 12.4 Implement document, estimate, and config/health routes
...
- [ ] 13. Implement React frontend and wire to backend
  - [ ] 13.1 Implement TaskIntakeForm and AssumptionsPanel
  ...
  - [ ] 13.2 Implement RoutingBlockView and StagedOutputWorkspace
  ...
  - [ ] 13.3 Implement SynthesisGatePanel, CcirAlertBanner, RunningEstimateView, DocumentLibraryView, and AiConfigHealth
